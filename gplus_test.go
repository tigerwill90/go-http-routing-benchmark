...
// Static
func BenchmarkFox_GPlusStatic(b *testing.B) {
	req, _ := http.NewRequest("GET", "/people", nil)
	benchRequest(b, gplusFox, req)
}
...
// One Param
func BenchmarkFox_GPlusParam(b *testing.B) {
...
// Two Params
func BenchmarkFox_GPlus2Params(b *testing.B) {
